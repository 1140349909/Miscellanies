...
.main[data-v-f5c55388] {
  margin-top: 35px;
  display: flex;
}
.left[data-v-f5c55388] {
  flex: 0;
  flex-shrink: 0;
  margin-left: 35px;
  margin-right: 35px;
}
.middle[data-v-f5c55388] {
  flex: 0;
  flex-shrink: 0;
  margin-right: 35px;
}
.right[data-v-f5c55388] {
  flex: 1;
}

.model[data-v-65e6cef8] {
...
.clock[data-v-65e6cef8]::before, .clock[data-v-65e6cef8]::after {
  position: absolute;
  content: '';
  width: 4px;
  height: 2px;
...
.clock[data-v-65e6cef8]::before {
  left: -3px;
  transform: rotate(-45deg);
}
.clock[data-v-65e6cef8]::after {
  right: -3px;
  transform: rotate(45deg);
}
.clock i[data-v-65e6cef8] {
  width: 1px;
  height: 4px;
  display: block;
  position: absolute;
...
.clock i[data-v-65e6cef8]::before {
  content: '';
  width: 2px;
  height: 1px;
  position: absolute;
...
.single[data-v-65e6cef8] {
  position: absolute;
  top: 8px;
  right: 15px;
  font-size: 12px;
}
.single i[data-v-65e6cef8] {
  width: 2px;
  display: inline-block;
  background: #444;
  margin-right: 2px;
...
.battery[data-v-65e6cef8]::before {
  content: '';
  width: 3px;
  height: 6px;
  position: absolute;
...
.body[data-v-65e6cef8] {
  width: 100%;
  height: 590px;
  margin-top: 25px;
}
.body iframe[data-v-65e6cef8] {
  width: 400%;
  height: 400%;
  transform: scale(.25);
  transform-origin: top left;
}
.body iframe.origin[data-v-65e6cef8] {
  width: 100%;
  height: 100%;
  transform: scale(1);
}
.bottom[data-v-65e6cef8] {
  width: 110px;
  height: 4px;
  border-radius: 2px;
  background: #444;
...
.image-wrapper[data-v-31c237fe] {
  text-align: center;
}
.card[data-v-31c237fe] {
  margin-bottom: 20px;
}
